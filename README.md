...
@adamite/cli/0.2.0-beta.1 darwin-x64 node-v10.17.0
...
_See code: [src/commands/start.ts](https://github.com/adamitejs/cli/blob/v0.2.0-beta.1/src/commands/start.ts)_
<!-- commandsstop -->
